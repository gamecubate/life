...
// lib/game/main.js
ig.baked=true;ig.module('game.main').requires('impact.game','impact.background-map','plugins.symbols.symbols','game.rule-set').defines(function(){FullsizeBackdrop=ig.Image.extend({resize:function(){},draw:function()
{if(!this.loaded)
{return;}
...
{ig.system.context.clearRect(0,0,ig.system.realWidth,ig.system.realHeight);this.parent();},});ig.main('#canvas',GameOfLife,30,320,480,1);});