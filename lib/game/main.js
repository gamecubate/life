...
GameOfLife = ig.Game.extend({
	...
	init: function()
	{
		...
		var bgMap = new ig.BackgroundMap (8, bgData, new ig.Image ('../media/cell_states.png'));
		...
		var cellsMap = new ig.BackgroundMap (8, cellStates, new ig.Image ('../media/cell_states.png'));
